          ...
          <div className="mb-10 text-center">
            ...
            <div className="relative inline-block group">
              <img
                ...
                alt="Foto de perfil"
                className="w-48 h-48 mx-auto rounded-full object-cover border-4 border-tur3 shadow-xl transition-all duration-300 group-hover:border-tur2 group-hover:shadow-2xl"
              />
              {uploadingPhoto && (
                <div className="absolute inset-0 mx-auto  flex items-center justify-center bg-black bg-opacity-60 rounded-full">
